...
echo "Now, some folders were created when painting the vpc. \n\n"
echo "vpc/ : the json-formatted files contain info about AWS VPC which fetched AWS through the AWS command line interface.\n"
echo "json/ : the json-formatted files contain processed info from the vpc folder.\n"
echo "graph/ : the png-formatted photoes generated by pydot through gotted data about AWS VPC.\n"
echo "\n"
